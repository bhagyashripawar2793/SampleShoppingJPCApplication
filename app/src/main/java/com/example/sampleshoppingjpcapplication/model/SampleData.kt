...
val  incaTrailVirtualMarathon =  Event(12,"Sports Shoes",R.drawable.inca_trail_event,incaTrail,0)
...
val reviews = listOf(
        Review( text = "This was a very comfortable walk. The view was breathtaking. We marveled at the rock formations and the beauty of the creek running through the mountains..", date = "13 Nav 2019",ratting = 5f,
